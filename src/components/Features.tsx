...
const features = [
  {
    icon: <Sparkles className="h-8 w-8 text-makemybio-purple" />,
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16 space-y-4">
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
            Why choose <span className="text-gradient">MakeMy.Bio</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            ...
            >
              {/* Icon container */}
              <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-makemybio-purple/10 to-makemybio-pink/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
              
              {/* Content */}
              <h3 className="font-bold text-xl mb-4 text-foreground group-hover:text-makemybio-purple transition-colors">
                {feature.title}
              </h3>
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/bio-generator" className="inline-block">
              <button className="bg-gradient-to-r from-makemybio-purple to-makemybio-pink hover:opacity-90 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl">
                Try Bio Generator
              </button>
            </a>
